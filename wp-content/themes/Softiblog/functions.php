...
function script_load_more($args = array()) {
    ...
    echo '<div id="ajax-primary" class="content-area">';
        ...
        echo '</div>';
        echo '<a href="#" id="loadMore"  data-page="1" data-url="'.admin_url("admin-ajax.php").'" >Charger plus d\'articles</a>';
    echo '</div>';
}
...
function ajax_script_load_more($args) {
    ...
    if ($query->have_posts()):
        ...
        /*if ( !is_archive() ? $wpQuery->have_posts() : have_posts() ) :
            ...
            include (TEMPLATEPATH . "/templates/grid/content-ajax.php");
        endwhile;
    else:
        echo 0;
    endif;
...
function ajax_enqueue_script() {
    wp_enqueue_script( 'script_ajax', get_template_directory_uri().'/assets/js/script_ajax.js', array( 'jquery' ), '1.0', true );
}

/*fin infinite scroll - click to load more*/